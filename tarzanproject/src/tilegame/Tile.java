 ...
 * 
 * The Tile class is an abstract class to compose the world (either grass or water).  
 * 
 */
...
public abstract class Tile {
	...
	/**
	 * Constructor. Create the tiles with a color (depending on the type, grass or water) and a unique ID.
	 * @param color, id
	 */
