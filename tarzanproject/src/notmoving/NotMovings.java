 ...
 * 
 *         The NotMovings class is an abstract class for all entities with a
 *         position and that don't move.
 * 
 */
public abstract class NotMovings { // = non moving
	protected final Position2D notMovingsPosition; // variable for the notmovings position
	protected final String notMovingsName; // variable for getting name of the not movings
