...
public class TarzanBackUp { 
	...
	public TarzanBackUp(Position2D pos, Level lvl, Settings setg){
		name = "Tarzan";
		tarzanPosition = pos;
		INITIAL_ENERGY = lvl.getInitialEnergy();
		energy = lvl.getInitialEnergy();
		strength = setg.getInitialStrength();
		endurance = setg.getInitialEndurance();
		isAlive = true;
		animalsKilled = 0;
	...
	public TarzanBackUp(Position2D pos){
		name = "Tarzan";
		tarzanPosition = pos;
		INITIAL_ENERGY = 300;
		energy = 300;
	...
	public TarzanBackUp(Position2D pos, Level lvl, int strength, int endurance){
		name = "Tarzan";
		tarzanPosition = pos;
		INITIAL_ENERGY = lvl.getInitialEnergy();
		energy = lvl.getInitialEnergy();
	...
	private void getMoves(Game2 game) { //call with this in Game2
		xMove = 0;
		yMove = 0;
